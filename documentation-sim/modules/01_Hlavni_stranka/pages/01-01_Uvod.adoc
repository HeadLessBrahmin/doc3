...
* (*1*) *Hlavní menu* - Umožňuje navigaci k základním funkcím serveru In-Počasí. Především se jedná o moduly xref:02_Aktualně::02-01_Uvod.adoc[Aktuálně], xref:03-01_Uvod.adoc[Radar], xref:04-01_Uvod.adoc[Předpověď] a xref:05-01_Uvod.adoc[Numerický model]. Detailní popis nalezneme v samostatných kapitolách této dokumentace.
